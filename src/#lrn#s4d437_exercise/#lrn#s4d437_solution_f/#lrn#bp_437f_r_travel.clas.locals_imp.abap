CLASS lsc_/lrn/437f_r_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_/lrn/437f_r_travel IMPLEMENTATION.

  METHOD save_modified.

    DATA(model) = NEW /lrn/cl_s4d437_tritem(
                        i_table_name = '/LRN/437F_TRITEM'
                      ).
...
*
  METHOD validateflightdate.
    ...
    READ ENTITIES OF /lrn/437f_r_travel IN LOCAL MODE
       ENTITY item
...
*
    ...
    MODIFY ENTITIES OF /lrn/437f_r_travel IN LOCAL MODE
    ENTITY travel
      UPDATE
      FIELDS ( begindate enddate )
