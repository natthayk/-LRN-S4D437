CLASS lsc_/lrn/437g_r_travel DEFINITION INHERITING FROM cl_abap_behavior_saver.
...
CLASS lsc_/lrn/437g_r_travel IMPLEMENTATION.

  METHOD save_modified.

    DATA(model) = NEW /lrn/cl_s4d437_tritem(
                        i_table_name = '/LRN/437g_TRITEM'
                      ).
...
*      RAISE ENTITY EVENT /lrn/437g_r_travel~travelcreated
*          FROM CORRESPONDING #( create-travel ) .

      DATA event_in TYPE TABLE FOR EVENT /lrn/437g_r_travel~travelcreated.
...
*  alternative with iteration inside a VALUE expression
*    IF create-travel IS NOT INITIAL.
*
*      RAISE ENTITY EVENT /lrn/437g_r_travel~travelcreated
...
*
  METHOD validateflightdate.
    ...
    READ ENTITIES OF /lrn/437g_r_travel IN LOCAL MODE
       ENTITY item
...
*
    ...
    MODIFY ENTITIES OF /lrn/437g_r_travel IN LOCAL MODE
    ENTITY travel
      UPDATE
      FIELDS ( begindate enddate )
